...
var testSusbs : Array = [
    ...
    ["You can also display numbers like PI: %f, and format them to a fixed precision, such as PI with 3 decimal places %.3f", Math.PI, Math.PI]/* Decimal precision examples*/
]
